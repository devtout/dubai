...
if(trim($name_contact) == '') {
	...
	exit();
} else if(trim($last_name_contact ) == '') {
	...
	echo '<div class="error_message"><i class="icon-attention"></i>Enter your message.</div>';
	exit();
	...
	echo '<div class="error_message"><i class="icon-attention"></i> Verification number is incorrect.</div>';
	exit();
}
...
$userheaders = "From: info@paradise.com\n";
$usermessage = "Thank you for contact HOTEL PARADISE. We will reply shortly!";
